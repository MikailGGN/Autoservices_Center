...
<!--<script language="JavaScript"  type="text/javascript" src="styles/mensu.js"></script>-->
...
header("Location: automobile_services.php"); 
}
mysql_close($db); 
...
<div class="ff">
<div class="top">
<img src="images/title.gif" width="686px" height="48px"  />
</div>
<div  class="midd">
...
<p>We are more than just experts in vehicle maintenance and repair. We are sure to keep your vehicle running <br/>
 at peak performance. We are equiped with high quality diagnostic tools for engine inspection and wheel service.<br />
  At De Kings Automobile Diagnosis center, our highly skilled mechanics  carefully diagnose every vehicle in <br />
   our garage and do it right the first time.
   <br />
   <br />
  We are overhual service center situated in Igando, Lagos.We guarantee best treatment for your car, suv, or truck. <br />
Some of the services we offer include:
</p>
<ul style="list-style:disc">
<li>Vehicle Inspection</li>
<li>Fuel Performance</li>
<li>Tranmission Service</li>
<li>Oil Change</li>
<li>Key Programming</li>
<li>Radio Decoding</li>
</ul>
<p>
...
function formCheck(formobj){
	...
	var fieldRequired = Array("fname","lname","email","phone","adate","year","make","model","servicetype_id");
	...
	var f=document.newad;
//alert('Thank you! we will be glad to have you visit.');
		f.refresh();
}
// -->
</script>
